...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""3f60477b-8833-4df1-aefe-7dc5ab8b98c8"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""7a77dbda-a7b7-47d2-9955-c773bc27dca9"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""c6fdde5e-7808-4892-a5eb-f9e4ca2450c8"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6dd214e6-67ce-49f8-9299-eb71e1c7b829"",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHandInteraction_Pause = m_XRIRightHandInteraction.FindAction("Pause", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRIRightHandInteraction_Pause;
    public struct XRIRightHandInteractionActions
    {
        ...
        public InputAction @Pause => m_Wrapper.m_XRIRightHandInteraction_Pause;
        ...
        public void SetCallbacks(IXRIRightHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface != null)
            {
                ...
                @Pause.started -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_XRIRightHandInteractionActionsCallbackInterface.OnPause;
            }
